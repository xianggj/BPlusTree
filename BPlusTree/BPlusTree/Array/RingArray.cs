...
namespace BPlusTree
{
    ...
    public sealed class RingArray<T> : IList<T>, IEnumerable<T>
    {
        ...
        {
            get { return Start + Count > Capacity; }
        }
        ...
        {
            get { return Count >= Capacity / 2; }
        }

        /// <inheritdoc />
        bool ICollection<T>.IsReadOnly
        {
            get { return Constraints != RingArrayConstraints.ReadOnly; }
        }
        ...
        public void Insert(int index, T item)
        {
            ...
            if (Constraints == RingArrayConstraints.FixedSize)
                throw new InvalidOperationException("can not insert to fixed size collection.");
        ...
        public T RemoveAt(int index)
        {
            if (Constraints == RingArrayConstraints.ReadOnly)
                throw new InvalidOperationException("can not modify readonly collection.");
            if (Constraints == RingArrayConstraints.FixedSize)
                throw new InvalidOperationException("can not remove from fixed size collection.");
        ...
        public int BinarySearch(T item, IComparer<T> comparer)
        {
            if (IsRotated)
            {
                if (comparer.Compare(item, array[Capacity - 1]) <=
                    0) // search right side if item is smaller than last item in array.
                {
        ...
        {
            InsertOrdered(item, Comparer<T>.Default);
        }
        ...
        {
            if (Constraints == RingArrayConstraints.FixedCapacity)
                throw new InvalidOperationException("can not expand fixed capacity collection.");
        ...
        public void Clear(bool resetCount)
        {
            if (Constraints == RingArrayConstraints.ReadOnly)
                throw new InvalidOperationException("can not modify readonly collection.");
            if (resetCount && Constraints == RingArrayConstraints.FixedSize)
                throw new InvalidOperationException("can not remove from fixed size collection.");
        ...
        {
            if (Constraints == RingArrayConstraints.FixedCapacity)
                throw new InvalidOperationException("can not trim fixed capacity collection.");
        ...
        public RingArray<T> SplitRight()
        {
            if (Constraints == RingArrayConstraints.ReadOnly)
                throw new InvalidOperationException("can not modify readonly collection.");
            if (Constraints == RingArrayConstraints.FixedSize)
                throw new InvalidOperationException("can not split fixed size collection.");
        ...
        public void MergeLeft(RingArray<T> right)
        {
            if (Constraints == RingArrayConstraints.ReadOnly)
                throw new InvalidOperationException("can not modify readonly collection.");
            if (Constraints == RingArrayConstraints.FixedSize)
                throw new InvalidOperationException("can not merge to fixed size collection.");
